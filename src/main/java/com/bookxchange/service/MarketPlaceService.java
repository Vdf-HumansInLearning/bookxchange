...
//            List<MarketBookDto> lsmarket = marketBookRepo.getAllMarketBookByBookStatus(BookStatus.AVAILABLE);
//
//        for (MarketBookDto mbd:lsmarket
//             ) {
//            System.out.println(mbd);
//        }
        ...
        System.out.println(marketBookRepo.getAllMarketBookById(UUID. fromString("102126b8-49a9-4eb3-bc4f-424d89a56f8b")));
